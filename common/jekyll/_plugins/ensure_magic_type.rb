...
module Jekyll
  module EnsureMagicTypeFilter
    ...
    def ensure_magic_type(input, type, *error_contexts)
      ...
      file_path = File.realdirpath(File.join(site_source, input))
      ...
      @@known_types.each do |known_type_name, known_type_magic|
        next unless magic_of_input_split.include? known_type_magic
      ...
      if detected_type
        raise_exception = true unless types.include? detected_type_key
      else
        ...
        if error_contexts.size > 0
          ...
          error_contexts.each do |error_context|
            ...
            @@known_types.keys.each do |known_type_key|
              ...
              next unless error_context.start_with? prefix
            ...
            next if starts_with_known_type
            raise Exception.new 'Multiple generic errors given.' unless generic_error_context.nil?

            generic_error_context = error_context
          end

          msg += "\n#{generic_error_context}" unless generic_error_context.nil?
